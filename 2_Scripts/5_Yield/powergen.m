...
validateattributes(PowerPerf_Rotor_W,...
    {'numeric'},{'2d','nonnegative','nonnan','nonempty','finite'});

validateattributes(Flow_Vel_Abs_PWA_ms,...
    {'numeric'},{'column','nonnegative','nonempty','finite'});

%% Index Match
[~,Idx] = ismember(round2(Flow_Vel_Abs_PWA_ms,0.1),...                      % Find whether power-weighted velocity value is held within the rounded power curves.
                   PowerPerf_Rotor_W(:,1)); 
