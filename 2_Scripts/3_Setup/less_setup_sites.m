...
%% Function Description - less_setup_sites - JAM 30/11/20
% This function extracts and processes site specifc data, as defined by the
% Scenario, in order to setup a SITES structure.
