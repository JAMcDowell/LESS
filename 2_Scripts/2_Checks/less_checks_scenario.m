...
% This function checks that the data loaded in by "less_load_scenario.m" is
% valid for the LESS tool.

%% Inputs Description
% SCENARIO - Structure of Scenario data.

% IN - Stucture of Input data.

%% Outputs Description
% This function will throw errors if checks are not completed successfully.
