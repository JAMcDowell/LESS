...
%% Inputs Description
% METOCEAN - Stucture of Metocean data.

% SCENARIO - Stucture of Scenario data.

% IN - Structure of Inputs data.

%% Ouputs Description
% METOCEAN - Stucture of Metocean data. Updated with data checked/corrected
% by this function.
...
if IN.RUN.SPATIAL 
    ...
    METOCEAN.SPATIAL.ChartDatum_Z_m...
        = squeeze(METOCEAN.SPATIAL.BathyXYZ_UTM_m(3,:,:));
