...
%% Function Description - neapaccess - JAM 08/11/20
% This function calculates the neap access windows and standby days based
% on flow velocities, the amount of daylight, and specified operation 
% durations/limits.
