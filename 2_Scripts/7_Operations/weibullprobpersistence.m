...
%% Function Description - weibullprobpersistence - JAM - 08/11/20
% This function calculates the Weibull probability of persistance for a
% weather window of specified duration.
